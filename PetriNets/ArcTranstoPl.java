...
public class ArcTranstoPl extends Arc {

    //private int weight;
    private Transition start;
    private Place end;
   ...
   // private long DestID;
    ...
    public ArcTranstoPl(){};
    public ArcTranstoPl(int weight, Transition start, Place end) throws IllegalArcWeightException, NullVertexException{
